        ...
        <div class="card-body">
            <div>
                <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/san-pham/view-add" role="tab" onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">Thêm
                            thông tin
                            sản phẩm</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/san-pham/hien-thi-delete" role="tab" onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                    ...
                                    <table class="table table-striped" style="color: black">
                                        ...
                                        <c:forEach items="${listSanPham}" var="sanPham" varStatus="index">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/san-pham/detail/${sanPham.id}"
                                                       ...
                                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                                        ...
                                                        Detail</a>
                                                    <a href="/san-pham/view-update/${sanPham.id}"
                                                       class="btn btn-warning btn-icon-text"
                                                       tabindex="-1"
                                                       role="button"
                                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                                        <i class="ti-file btn-icon-prepend"></i>
                                                        Update</a>
                                                    <a href="/san-pham/view-ctsp/${sanPham.id}"
                                                       class="btn btn-warning btn-icon-text"
                                                       tabindex="-1"
                                                       role="button"
                                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                                        <i class="ti-file btn-icon-prepend"></i>
                                                        Xem danh sách CTSP</a>
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination justify-content-center pagination-lg">
                                                <li class="page-item"><a class="page-link"
                                                                         href="/san-pham/hien-thi?pageNum=0"><<</a>
                                                </li>
                                                ...
                                                <li class="page-item"><a class="page-link"
                                                                         href="/san-pham/hien-thi?pageNum=${total-1}">>></a>
                                                </li>
                                            </ul>
                                        </nav>
                                    </c:if>
