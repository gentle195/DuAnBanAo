                ...
                <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab"
                           aria-controls="description" aria-selected="true">Thông tin chất liệu ngưng sử dụng</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <%--            Tìm kiếm               --%>
                                <form action="/chat-lieu/search-ngung-hoat-dong" method="post">
                                    ...
                                    <table class="table table-striped" style="color: black">
                                        ...
                                        <c:forEach items="${listChatLieu}" var="chatLieu" varStatus="index">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/chat-lieu/detail-ngung-hoat-dong/${chatLieu.id}"
                                                       ...
                                                       onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">
                                                        ...
                                                        Detail</a>
                                                    <a href="/chat-lieu/khoi-phuc/${chatLieu.id}"
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination justify-content-center pagination-lg">
                                                <li class="page-item"><a class="page-link"
                                                                         href="/chat-lieu/hien-thi-delete?pageNum=0"><<</a>
                                                </li>
                                                <c:forEach begin="1" end="${totalPage}" varStatus="status">
                                                    <li class="page-item">
                                                        <a href="/chat-lieu/hien-thi-delete?pageNum=${status.index -1}"
                                                           class="page-link">${status.index}</a>
                                                    </li>
                                                </c:forEach>
                                                <li class="page-item"><a class="page-link"
                                                                         href="/chat-lieu/hien-thi-delete?pageNum=${total-1}">>></a>
                                                </li>
                                            </ul>
                                        </nav>
                                    </c:if>
