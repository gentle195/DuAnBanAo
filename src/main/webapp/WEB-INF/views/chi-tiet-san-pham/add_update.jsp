        ...
        <div class="row ">
            <div class="col-lg-6 ">
                <div class="item inp">
                    ...
                    <form:input path="sanPham.ten" value="${tensp}" cssStyle="margin-left: 12px"
                                readonly="true"/>
                </div>
                <div class="item inp">
            ...
            <div class="col-lg-6 ">
                <div class="item-right">
                    <label class="form-label" cssStyle="margin-right: 15px;margin-left: 35px;">Loại Cổ Áo <span
            ...
            <div class="modal-content">
                <form:form modelAttribute="lg" method="post" action="${action4}">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Thêm Cỡ Áo</h1>
