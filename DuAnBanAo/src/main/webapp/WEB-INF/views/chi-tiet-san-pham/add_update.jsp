            ...
            <div class="row ">
                <div class="col-lg-6 ">
                    <div class="form-group">
                        ...
                        <form:input path="sanPham.ten" class="form-control" value="${tensp}"
                                    cssStyle="margin-left: 12px;width: 400px"
                                    readonly="true"/>
                    </div>

                    <div class="item inp">
                        <label class="form-label">Giá Bán <span style="color: red">*</span> : </label>
                        <form:input class="form-control" path="giaBan" type="number" min="1"
                                    cssStyle="margin-left: 12px;width: 400px"/>
                ...
                <div class="col-lg-6 ">
                    <div>
                        ...
                        <form:select type="text" id="searchName10" path="thuongHieu" class="form-control"
                    ...
                    <div class="item-right">
                        ...
                        <form:select type="text" id="searchName14" path="chatLieu" class="form-control"
                                     cssStyle="width: 400px">
                    ...
                    <div class="item-right">
                        <label class="form-label" cssStyle="margin-right: 15px;margin-left: 35px;">Cổ áo <span
                                style="color: red">*</span> : </label>
                        <form:select type="text" id="searchName13" path="coAo" class="form-control"
                                     cssStyle="width: 400px">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="input-group">
                            ...
                            <label class="form-label" style="margin-right: 50px;">Kích cỡ <span
                                    style="color: red">*</span>
                                : </label>

                            <form:select class="js-example-basic-multiple" name="states[]" multiple="multiple"
                                         id="searchName11"
                                         path="kichCo" cssClass=".searchName1 form-control" onChange="updateTable()"
                                         cssStyle="width: 400px">
                    ...
                    <div class="col-6">
                        <div class="input-group">
                            ...
                            <label class="form-label" style="margin-right: 5px;">Màu sắc <span
                                    style="color: red">*</span> :
                            </label>

                            <form:select class="js-example-basic-multiple" name="states[]" multiple="multiple"
                                         id="searchName12"
                                         path="mauSac" cssClass=".searchName2 form-control" onChange="updateTable()"
                                         cssStyle="width: 400px">
...
<div class="text-center" style="color: crimson">${mess}</div>
<script src="../../../js1/chi_tiet_san_pham/chi_tiet_san_pham.js"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
