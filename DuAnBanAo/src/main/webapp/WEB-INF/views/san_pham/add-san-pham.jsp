...
<body>
<h3><b>Sản phẩm</b> / Thêm, Sửa sản phẩm</h3>
<div class="card">

    <div class="card-body">
        <form:form modelAttribute="SP" method="post" action="${action}" cssClass="form">

        <h4 style="text-align: center">Thêm/Sửa thông tin sản phẩm</h4>
        ...
        <button type="submit" class="btn mb-1 btn-primary" style="margin-left: 600px">Submit</button>
